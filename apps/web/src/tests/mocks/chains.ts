...
const CONFIG_SERVICE_CHAINS: ChainInfo[] = [
  ...
  {
    transactionService: 'https://safe-transaction.xdc.gnosis.io',
    contractAddresses,
    chainId: '50',
    ...
    l2: false,
    isTestnet: false,
    description: 'XDC Network - Enterprise-grade Layer 1 blockchain',
    rpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://rpc.ankr.com/xdc' },
    safeAppsRpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://rpc.ankr.com/xdc' },
    publicRpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://rpc.ankr.com/xdc' },
    blockExplorerUriTemplate: {
      address: 'https://xdcscan.com/address/{{address}}',
      txHash: 'https://xdcscan.com/tx/{{txHash}}',
      api: 'https://xdcscan.com/api?module={{module}}&action={{action}}&address={{address}}&apiKey={{apiKey}}',
    },
    nativeCurrency: {
      name: 'XDC',
      symbol: 'XDC',
      decimals: 18,
      logoUri: 'https://safe-transaction-assets.gnosis-safe.io/chains/50/currency_logo.png',
    },
    theme: { textColor: '#ffffff', backgroundColor: '#00ADEF' },
    gasPrice: [{ type: GAS_PRICE_TYPE.FIXED, weiValue: '25000000000' }],
    disabledWallets: [
      'authereum',
      'fortmatic',
      'keystone',
